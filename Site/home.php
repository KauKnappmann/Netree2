...
<?php
 ...
 //CATALOGO
    ...
    foreach($plantas as $planta){   
        ...
        $plantas_sub = $plantas_sub."<div class='item'><div class='item-entry'><a href='produto/produtos.php' class='product-item md-height bg-gray d-block'><img style='width: 250px;height: 250px;' src='Upload/Plantas/".$planta['img']."' alt='Image' class='img-fluid'></a>";
