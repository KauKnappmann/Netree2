  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <div class="icons">
            ...
            <a href="../carrinho.php" class="icons-btn d-inline-block bag" title="Carrinho">
    ...
    <div class="row">
        ...
        foreach($plantas as $planta){   
           ...
           style='width: 60%;' type='submit' name='cod' value='plantas&".$count."&".($planta['cod']-1)."'>Comprar</button></form></h6></div>";
           $count++;
          }
